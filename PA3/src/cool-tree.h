...
class Class__class : public tree_node {
  public:
    ...
    virtual Symbol getdad() = 0;
    virtual Features getfeatures() = 0;
    unordered_map<Symbol, Feature> *methods;
    unordered_map<Symbol, Feature> *attrs;
#ifdef Class__EXTRAS
    Class__EXTRAS
#endif
};
...
class branch_class : public Case_class {
  ...
  public:
    ...
    Symbol getname() { return name; }
    Symbol gettruetype();
    Symbol getdecltype() { return type_decl; };
