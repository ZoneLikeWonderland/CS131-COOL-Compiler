...
template <class Elem> class list_it : public std::iterator<std::random_access_iterator_tag, Elem> {
  private:
    int p;
    list_node<Elem> *cp;

  public:
    list_it(int x, list_node<Elem> *y) : p(x), cp(y) {}
    friend bool operator!=(list_it<Elem> a, list_it<Elem> b) { return a.p != b.p; }
    list_it<Elem> operator++() {
        p++;
        return *this;
    }
...
template <class Elem> class list_node : public tree_node {
  public:
    ...
    list_it<Elem> begin() { return list_it<Elem>(0, this); }
    list_it<Elem> end() { return list_it<Elem>(len(), this); }
};
...
//
///////////////////////////////////////////////////////////////////////////
template <class Elem> list_node<Elem> *nil_node<Elem>::copy_list() { return new nil_node<Elem>(); }
...
//
///////////////////////////////////////////////////////////////////////////
template <class Elem> void nil_node<Elem>::dump(ostream &stream, int n) { stream << pad(n) << "(nil)\n"; }
...
//
///////////////////////////////////////////////////////////////////////////
template <class Elem> void single_list_node<Elem>::dump(ostream &stream, int n) { elem->dump(stream, n); }
...
//
///////////////////////////////////////////////////////////////////////////
template <class Elem> int append_node<Elem>::len() { return some->len() + rest->len(); }
...
template <class Elem> void append_node<Elem>::dump(ostream &stream, int n) {
    ...
    size = len();
    stream << pad(n) << "list\n";
    for (i = 0; i < size; i++) this->nth(i)->dump(stream, n + 2);
...
//
///////////////////////////////////////////////////////////////////////////
template <class Elem> single_list_node<Elem> *list(Elem x) { return new single_list_node<Elem>(x); }
...
//
///////////////////////////////////////////////////////////////////////////
template <class Elem> append_node<Elem> *cons(Elem x, list_node<Elem> *l) { return new append_node<Elem>(list(x), l); }
...
//
///////////////////////////////////////////////////////////////////////////
template <class Elem> append_node<Elem> *xcons(list_node<Elem> *l, Elem x) { return new append_node<Elem>(l, list(x)); }
